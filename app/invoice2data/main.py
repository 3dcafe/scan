...
from .input import pdf2image_wrapper
...
def extract_data(invoicefile, templates=None, input_module=pdftotext, language='en'):
    ...
    language : {'deu', 'eng', 'rus', 'fra'}, optional
        library to be used to extract deafault = 'eng'
    ...
    # print(templates[0])
    extracted_str = input_module.to_text(invoicefile, language=language)#.decode("utf-8")
